...
Quote.create(price: "100", comment: "I would love to take care of him for a couple hours!", post_id: "2", user_id: "3")
Quote.create(price: "60", comment: "Gardening is like my therapy.", post_id: "3", user_id: "2")
Quote.create(price: "400", comment: "I love to travel and spend time with people.", post_id: "4", user_id: "5")
Quote.create(price: "100", comment: "I'm botanical expert.", post_id: "5", user_id: "4")
